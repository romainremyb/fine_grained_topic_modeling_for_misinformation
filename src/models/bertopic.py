...
class BERTopicWrapper(AbstractModel):
    ...
    """
    def __init__(self, docs, IDs, nb_topics=None, min_topic_size=6, fine_tune=True, umap_param={'n_neighbors': 15, 'n_components': 5},
                    representation_model = None, vectorizer_params = {
        ...
        self.vectorizer(strip_accents= vectorizer_params['strip_accents'],
